...
class unicaenSearchEngine():
    ...
    ###
    #   Cherche une suite de terme afin de renvoyer le meilleur document correspondant
    #   
    #   Parameters
    #   ...
    #   phrase :str
    #       Phrase qui recherchera plusieurs termes dans la matrice
    #   Return
    #   ...
    #       list de lien avec leur coefficient classé dans l'ordre croissant
    ###
        ...
        for word in words : 
            ...
            if not(res == None):
                for element in res : 
                    ...
                    if (len(dictionnary[element[0]][1])>1):
                        dictionnary[element[0]][0]+= 1
